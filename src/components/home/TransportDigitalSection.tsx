      ...
      <div className="container px-4 mx-auto">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Uthutho transforms everyday commuting into a shared digital system.
            By using real-time, community-powered data, we make informal transport
            more visible, predictable, and accessible—without changing how it operates.
          </p>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
            <div className="p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10">
              ...
              <p className="text-gray-400">
                See active routes, stops, and transport activity in real time,
                powered by commuters on the ground.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10">
              ...
              <p className="text-gray-400">
                Commuters share live updates about delays, availability, and
                journey progress—turning everyday travel into shared intelligence.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10">
              ...
              <p className="text-gray-400">
                Know what to expect before you travel—from estimated pricing
                to route activity—bringing structure to an informal system.
              </p>
            </div>
          </div>
        </div>
